...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-base-200 text-base-content">
            <div>
                <img className='h-32 w-32 rounded' src={logo} alt="" />
                <p>My Kitchen<br />Providing home made foods since 2022</p>
            ...
            <div>
                ...
                <a href="/" className="link link-hover">Taking Orders</a>
                <a href="/" className="link link-hover">Weeding Plan</a>
                <a href="/" className="link link-hover">Birthday Plan</a>
            </div>
            <div>
